...
window.SITE_CONFIG = {
  ...
  services: [
    ...
    {
      page: "lintel-repair-replacement.html",
      name: "Lintel repair and replacement",
      shortName: "Lintels",
      shortDescription: "Rusted and failing lintels over windows and doors. How to tell a lintel problem from a footing problem, and what replacing one involves.",
      serviceType: "Lintel repair and replacement",
      metaTitle: "Lintel Repair & Replacement Perth | Rusted Lintels",
      metaDescription: "Rusted lintel repair and replacement in Perth. How to tell a lintel crack from footing movement, why the steel corrodes, and what a replacement involves.",
      headline: "Lintel repair and replacement in Perth",
      subheadline: "The steel beam over a window or door rusts, expands, and lifts the brickwork above it. It looks like a structural crack, and it is usually the cheapest structural-looking problem you will ever be quoted for.",
      ctaText: "Tell us what you are seeing",
      ...
      blocks: [
        ...
        { h2: "What a lintel is, and why Perth is full of them" },
        {
          p: [
        ...
        { h2: "Telling a lintel crack from a movement crack" },
        {
          p: [
        ...
        /* TODO (Brad): a real photograph of a rusted Perth lintel with the
           classic horizontal head crack and rust stain would be a strong
           upgrade on the diagram below, and would be the only one of its kind
           in this market. Same rule as the crack-types diagram on the repairs
        ...
        {
          note: "Corrosion protection for lintels built into masonry is covered by AS 2699.3:2020, [Built-in components for masonry construction: Lintels and shelf angles (durability requirements)](https://store.standards.org.au/product/as-2699-3-2020), and masonry design generally by AS 3700. The advice that continuous flashing belongs over the angle even where galvanised or stainless steel has been used, and that lintel deflection is itself a common cause of cracking over openings, is from the US Brick Industry Association's [Technical Note 31B, Structural Steel Lintels](https://www.gobrick.com/media/file/31b-structural-steel-lintels.pdf) - cited for the mechanics of how these members fail, not as an Australian compliance requirement. Moisture and salt behaviour in Perth walls follows [City of Fremantle, Technical Advice Sheet 5: Dealing with dampness in old walls](https://www.fremantle.wa.gov.au/wp-content/uploads/2025/04/Technical-Advice-Sheet-5-Dealing-with-dampness-in-old-walls.pdf)." },

        { h2: "The other reason brickwork cracks over an opening" },
        { p: "Not every crack at a window head is corrosion. A lintel that was undersized, or that was never designed at all because someone picked a section by eye, deflects under the load it is carrying. The masonry sitting on it cannot follow that sag, so it cracks. The Brick Industry Association names inadequate lintel design as a common cause of cracking over openings, and sets the serviceability limit at 1/600 of the clear span or 8mm, whichever is smaller - which is a tighter tolerance than most people expect, and the reason \"it only sags a little\" is not reassuring. Bearing matters for the same reason: the lintel has to sit far enough onto the brickwork at each end to spread its load, with 75mm each end treated as a floor rather than a target." },

        { h2: "What replacing a lintel involves" },
        {
          p: [
        ...
        { p: "**Where this stops being a bricklaying decision.** If the opening is being widened, if the wall is load bearing and the work goes beyond like-for-like replacement, or if there is any question about what is actually carrying the load, that is engineering territory and generally permit territory. Structural certification in WA has to be endorsed by a professional engineer - the City of Perth, for instance, requires a Certificate of Structural Sufficiency for exactly that assurance. Straight replacement of a failed lintel with an equivalent one is ordinary repair work; changing what the wall does is not." },
        {
          note: "The certification requirement and its wording are from the [City of Perth's Certificate of Structural Sufficiency](https://perth.wa.gov.au/en/forms-and-payments/building-planning-and-development/building-permits-licences-and-approvals/certificate-of-structural-sufficiency), which states its purpose is \"to provide the City of Perth with assurance that the structural design, materials and form of construction for the proposed building work(s) complies in all respects with the relevant deemed-to-satisfy provisions of the Building Code of Australia\" and requires endorsement by a professional engineer. Requirements are set by each local government as permit authority under the Building Act 2011, so check with the council your property sits in rather than assuming Perth's process applies." },

        { h2: "What lintel replacement costs in Perth" },
        {
          p: [
        ...
        { h2: "Frequently asked questions" },
        {
          faqs: [
            {
              q: "There is a horizontal crack above my window. Is that serious?",
              a: "It is worth acting on, but it is usually a lintel rather than the house subsiding, and that is the better of the two answers. A horizontal crack sitting in one mortar joint at the head of an opening, especially with rust staining or brickwork lifted above it, points at the steel over the opening rather than at the footings. Diagonal stepped cracking is the pattern that points at movement instead."
            },
            {
              q: "What is the rusty brown stain coming out of my brickwork?",
              a: "Almost always the lintel. Water inside the wall reaches the steel, corrodes it, and carries iron oxide out through the mortar joint. It is a symptom rather than a stain to clean off - the steel behind it is expanding while it does that, and cleaning the brick face does nothing about the cause."
            },
            {
              q: "Can a rusted lintel just be treated rather than replaced?",
              a: "Sometimes, if it is caught early and the corrosion is superficial. Once the steel has expanded enough to lift the brickwork above it, the expansion is the problem, and treating the surface does not reverse it. What the situation always needs, in either case, is the water source found and stopped."
            },
            {
              q: "Do I need a building permit to replace a lintel?",
              a: "Like-for-like replacement of a failed lintel is ordinary repair work. Widening the opening, changing what the wall carries, or anything that alters the structure is a different matter, and structural certification in WA has to be endorsed by a professional engineer. Permits are administered by your local council as permit authority, so confirm with the council your property is in."
            },
            {
              q: "How long does a lintel last?",
              a: "There is no single answer, because it depends almost entirely on how much water the steel has been sitting in. A galvanised lintel that is properly flashed, with a cavity that drains and weep holes that are clear, can outlast the people living in the house. The same lintel under a leaking gutter, or in a wall whose weep holes were rendered over, can fail in a fraction of that."
            },
            {
              q: "Why did my windows start sticking?",
              a: "Worth checking the head of the opening if it happened without any other explanation. A lintel that is corroding and expanding, or deflecting under load, distorts the opening it is supposed to be holding square, and a door or window that has been fine for decades starts binding in its frame."
            },
            {
              q: "Can you fill the weep holes above my window? They look untidy.",
              a: "No, and filling them is one of the reliable ways to cause the problem this page is about. Weep holes drain the cavity. Blocked, the water stays in the wall and goes to work on the steel over your openings."
            },
            {
              q: "How much does lintel replacement cost?",
              a: "It is priced per opening, and support, access and how much brickwork the corrosion has already damaged move it more than the width of the window does. Send through what you are seeing via [the enquiry form](#enquiry), by phone on (08) 9516 1337, or by emailing hello@perthbrickwork.com.au, and we can give you a proper indication once we know the job."
            }
          ]
        },
        {
          form: {
            headline: "Tell us what you are seeing",
            preset: "Lintel repair or replacement",
            placeholders: {
              size: "e.g. horizontal crack and rust staining above the front window, single storey, 1960s double brick"
            },
            extraFields: [
              {
                name: "buildingAge",
      ...
      blocks: [
        ...
        { h2: "Perth's federation and heritage suburbs" },
        {
          p: [
            ...
            "**Mount Lawley.** Federation through to the inter-war building boom of the 1920s and 30s, when Mount Lawley, Inglewood and Maylands together added thousands of houses in Californian Bungalow and Spanish Mission styles. Beaufort Street is the clearest expression of the suburb's character now: heritage shopfronts and houses standing alongside a thoroughly modern cafe and bar strip, which is why the City of Vincent runs both heritage areas and a separate set of character areas rather than one blanket rule.",
        ...
        {
          p: "The Heritage Act 2018 requires every local government in WA to record places of heritage significance in a Local Heritage Survey, and each council in the table below also keeps a Heritage List of individual places. Some designate heritage areas or character areas as well - whole streets or precincts with planning controls of their own. If your council is not in the table, its planning department can tell you whether your address is on its Heritage List or inside a heritage area."
        },

        { h3: "How this section was put together" },
        {
          p: [
            "Each card is drawn from that council's own published heritage page, Heritage List, Local Heritage Survey and heritage-area policies, and shows the date it was checked. Councils update these documents, so follow the link on the card for the current version.",
            "A listing tells you a place is protected. It does not tell you whether a particular repointing or restoration job needs approval: several councils say approval is needed for most works, or in most instances, rather than for all of them.",
            "This is not legal advice. Your council's answer is the authoritative one."
          ]
        },
        ...
        { h3: "Perth councils: heritage lists and heritage/character areas" },
        {
          ...
          cards: {
            ...
            rows: [
              ["City of Bayswater", "Places in the Local Heritage Survey graded Management Category 1 to 3 go on the City's Heritage List. Development approval is required for all demolition, alterations or other development affecting the heritage significance of a listed place or area.", "The Bayswater town centre and the Maylands town centre are designated heritage areas.", "https://www.bayswater.wa.gov.au/development/heritage/local-heritage-survey", "11/09/2026"],
              ["City of Fremantle", "The Heritage List carries around 2,500 places, and the Local Heritage Survey records more than 5,000. In most circumstances, development on a listed place or in a heritage area needs planning approval, so the City's heritage staff can assess the impact first.", "23 heritage areas, including Central Fremantle, North Fremantle, South Fremantle and Hilton.", "https://www.fremantle.wa.gov.au/planning-and-building/heritage/heritage-listings-and-areas/", "13/09/2026"],
              ["City of Nedlands", "The Heritage List forms part of Local Planning Scheme No. 3, gazetted April 2019.", "Four heritage areas are proposed - Clifton Street, Meriwa Street, Mountjoy Road and Tyrell Street - together with a draft Local Planning Policy 6.2: Heritage-Protected Places. In June 2024 Council removed part of Tyrell Street North, between Edward Street and Stirling Highway, from the proposal.", "https://yourvoice.nedlands.wa.gov.au/heritage-areas", "13/09/2026"],
              ["City of Perth", "A Heritage List of individual places of cultural heritage significance.", "Seven heritage areas are proposed, each with its own draft local planning policy: West End, William Street, Barrack Street, Hay Street Mall, East End, Pier Street, and Goderich Street in East Perth - a concentration of late 19th century houses between Bennett and Forrest Streets.", "https://yoursay.perth.wa.gov.au/lps3-heritage-areas", "13/09/2026"],
              ["City of South Perth", "Heritage List adopted by Council in October 2025, informed by the City's Local Heritage Survey 2025.", "The City's heritage page lists individual places rather than named heritage areas.", "https://southperth.wa.gov.au/development/planning/local-heritage", "13/09/2026"],
              ["City of Subiaco", "A Heritage List of individual places, with the Local Heritage Survey reviewed precinct by precinct - the West Subiaco Precinct was endorsed 28 June 2022 and the Daglish Precinct 27 August 2024.", "Ten heritage areas: Kershaw Street, Rokeby Road and Hay Street, Union and Redfern, Chesters' Subdivision, Duke Street, Kings Road, Hamersley Road Group, Sadlier and Redfern Street, Salisbury and Rupert Street, and Park Street, the most recent, adopted May 2024.", "https://www.subiaco.wa.gov.au/plan-build/build-renovate/heritage/heritage-listings", "13/09/2026"],
              ["City of Swan", "Heritage List under Local Planning Scheme No. 17, alongside a Local Heritage Survey - previously the Municipal Inventory of Heritage Places.", "Two heritage areas: Guildford-Mandoon, under a local planning policy adopted 5 October 2022, and Woodbridge, under the Woodbridge Conservation Precinct Local Planning Policy. Guildford is also on the State Register of Heritage Places.", "https://www.swan.wa.gov.au/plan-and-build/heritage", "13/09/2026"],
              ["City of Vincent", "Heritage List 2026, alongside the Local Heritage Survey 2026. Owners of a place on the Heritage List need development approval for most works.", "Three heritage areas - Harley Street, Janet Street, and Brookman and Moir Streets - and eleven character areas: St Albans Avenue, Carr Street, Boulevarde and Matlock Street, Florence Street, Prospect Place, Hammond Street, Strathcona Street, Wilberforce Street, Orange Avenue and Hope Street, Lacey Street, and Auckland Street. The City's Character Area Guidelines came into effect on 1 August 2026.", "https://www.vincent.wa.gov.au/plan-build/plan/design/heritage.aspx", "13/09/2026"],
              ["Shire of Peppermint Grove", "Heritage List and Local Planning Policy 3 - Heritage Places, alongside the Shire's Local Heritage Survey 2021. In most instances, building and demolition work on a Heritage List property needs development approval.", "The Shire's heritage page lists individual places rather than named heritage areas.", "https://www.peppermintgrove.wa.gov.au/development/important-information/heritage.aspx", "13/09/2026"],
              ["Town of Bassendean", "Development approval is required for all demolition, alterations or other development affecting the heritage significance of a place on the Heritage List. The Local Heritage Survey, previously the Municipal Heritage Inventory, was most recently amended 26 August 2025.", "Five heritage areas under Local Planning Policy No. 4 - Heritage and Character: Old Perth Road, Devon Road and Kenny Street, adopted 24 May 2022, and Earlsferry and Nurstead Avenue, adopted since.", "https://www.bassendean.wa.gov.au/develop-build/planning-development/heritage.aspx", "13/09/2026"],
              ["Town of Cambridge", "The Town's first Heritage List was adopted 27 November 2018 carrying 74 places, drawn from a Local Government Inventory of 118 places - now called a Local Heritage Survey. The List has been amended twice since, most recently 15 December 2020. Listing means planning approval is required for demolition and most development works.", "The Holyrood Street Conservation Area in West Leederville, covering Holyrood Street between Cambridge Street and Woolwich Street - the first heritage-listed street in the Town, with its own design guidelines dating to 2002. Applications for additions or new works within the precinct are referred to the Town's Heritage Architect.", "https://www.cambridge.wa.gov.au/Planning-Building/Planning/Planning-Rules/Heritage-Character", "11/09/2026"],
              ["Town of Claremont", "Local Heritage Survey and Heritage List, reviewed in 2014-15 and again in 2022, with Local Planning Policy 124 - Heritage and Local Planning Policy 123 - Retention of Residential Character. Demolition of any place on the Heritage List or the State Register needs development approval.", "Bay View Terrace Heritage Area (Local Planning Policy 208) and Claremont Crescent Heritage Area (Local Planning Policy 209).", "https://www.claremont.wa.gov.au/services/planning-and-building/heritage/heritage-places/", "13/09/2026"],
              ["Town of Cottesloe", "Heritage List under the Local Planning Scheme, alongside a Local Heritage Survey - previously called a Municipal Inventory - updated in 2025. Places on the Heritage List need development approval for most development works, and a Heritage Impact Statement may be required with the application.", "The Town's heritage page lists individual places rather than named heritage areas.", "https://www.cottesloe.wa.gov.au/develop-build/planning/heritage.aspx", "13/09/2026"],
              ["Town of East Fremantle", "Heritage List under Local Planning Scheme No. 3. The Local Heritage Survey grades places from Category A, Conservation Essential, to Category D, Recording Required.", "One heritage area: the George Street Designated Heritage Area, between East Street and Stirling Highway, under Local Planning Policy 3.1.6, adopted February 2020. It replaced the older George Street Precinct.", "https://www.eastfremantle.wa.gov.au/george-street-designated-heritage-area-policy.aspx", "13/09/2026"],
              ["Town of Mosman Park", "Local Heritage Survey, Heritage List and Local Planning Policy 34 - Management of Heritage Places, all adopted by Council on 27 August 2024. Places graded Category 1 or 2 go on the Heritage List, where any proposed modification, addition or demolition needs planning approval.", "The Town's heritage page lists individual places rather than named heritage areas.", "https://www.mosmanpark.wa.gov.au/build/planning-information/heritage/", "13/09/2026"],
              ["Town of Victoria Park", "Heritage List with Local Planning Policy No. 43 - Heritage List, alongside the Local Heritage Survey 2021 - previously the Municipal Heritage Inventory. In most instances, building and demolition work on a Heritage List property needs development approval, apart from some minor works, and may need a Heritage Assessment.", "The Town's heritage page lists individual places rather than named heritage areas.", "https://www.victoriapark.wa.gov.au/develop-and-build/planning/planning-policies-and-legislation/local-heritage.aspx", "13/09/2026"]
            ]
          }
        },
        /* TODO (Brad): this table is built from each council's published
           heritage documents, not from calling anyone. It deliberately has no
           "is repointing a street-facing facade approvable work" column - that
           answer needs phoning each council, and a guessed answer would be
           worse than none (same reasoning as the pricing tables). When you work
           through the sixteen councils, add it as a sixth column rather than a
           separate table. Only the federation/interwar-dense councils are
           covered - see notes/heritage-table-port-plan.md for the rest.

           Every row was traced to the council's own page or document on
           11-13 September 2026. Search-result summaries repeatedly stated
           Wikipedia's "N places heritage-listed, M on the State Register"
           figures as if they were council figures - don't reintroduce counts
           from anything but the council itself.

           Open discrepancy: City of Fremantle's heritage page says the Heritage
           List has "around 2,500" places, but its 2026 annual heritage update
           FAQ (mysay.fremantle.wa.gov.au) says "approximately 2,380". The row
           follows the page it links to. Worth a call to the City to settle.

           Vincent replaced its Character Retention Areas policy with separate
           Heritage Area Guidelines and Character Area Guidelines, the latter in
           effect 1 August 2026. Re-check Vincent first on any refresh. */

        {
          p: "If your address is on any of these lists, or inside a heritage or character area, check with that council's planning department before you commit to a repointing, rendering or restoration scope - the work itself is not necessarily different, but the approval pathway is."
        },
    ...
    },
    {
      ...
      blocks: [
        ...
        /* TODO (Brad): add a real photo of a vehicle gate opening with piers, for scale,
           once one exists. Deliberately shipped without one rather than an illustrative
           stock/generated image — see README "images currently on the site are illustrative". */
        ...
        {
          note: "Wind loading on structures in Australia is governed by **AS/NZS 1170.2** (Structural design actions - Wind actions), and design of the masonry itself by **AS 3700**, already named above. Perth sits in the non-cyclonic wind region, well south of the cyclone-prone regions covering WA's northern and northwestern coast. There is no single wind speed, height threshold or pier-spacing figure that holds across the city: the wind region is broadly constant across the metro area, but **terrain category**, how sheltered or exposed a given frontage is, varies street to street. Pier spacing is a site-specific engineering calculation rather than a number you can look up." },
  ...
  homeBlocks: [
    ...
    {
      p: [
        "**1. Check registration on larger jobs.** Building work in Western Australia has to be carried out by a registered building contractor, rather than engaged with a tradesperson directly, once it needs a building permit and the value reaches $20,000 - or $50,000 where the work is a Class 10a building such as a private garage, shed or carport. Fences, free-standing walls and retaining walls are the exception: they are classed as incidental structures and sit outside the registration requirement whatever they cost, which is why a substantial brick fence can still be engaged with a bricklayer directly. Building and Energy publishes a public register you can search by name or registration number, and it takes about a minute. If your job is over those thresholds, or anyone is quoting to build rather than to repair, check it.",
    ...
    {
      note: "Registration thresholds are from [Building and Energy's builders' registration guidance](https://www.wa.gov.au/government/multi-step-guides/builders-registration), which requires contractor registration where the building work requires a building permit, has a value of \"$50,000 or more if the work relates to a Class 10a building (such as a private garage, shed or carport); or $20,000 or more for other types of building work\", and is located within the area of the Building Services Board's jurisdiction. The incidental-structure exclusion, which covers a \"chimney; mast; swimming pool; fence; free standing wall; retaining wall\" among others, is from [Do I need to be a registered building contractor?](https://www.wa.gov.au/government/publications/do-i-need-be-registered-building-contractor). Being outside the registration requirement does not put a structure outside the need for a building permit, and both thresholds and exclusions are subject to change - confirm current requirements before relying on them for a particular job."
    },
  ...
  aboutBlocks: [
    ...
    {
      p: [
        "Perth Brickwork is run by Brad - born and bred in country WA and now living in Perth. Perth Brickwork is a registered business, operating under ABN 78 538 005 810.",
        "Before this I spent two years in the construction materials industry. I have not laid brick and I do not claim to, but I can help connect you up with some great people who can. For how a specific job gets built, the bricklayer is the one to ask."
      ]
    },
