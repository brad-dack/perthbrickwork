  ...
  services: [
...

    {
      ...
      blocks: [
        ...
        {
          p: [
            "The table below was built by reading each council's published Local Heritage Survey, Heritage List and heritage-area local planning policy documents - the same public record a council planning officer would point you to. Every row records the date it was checked. Where a council does not publish a figure, the row says so rather than carrying a number from a third-party site.",
        ...
        { h3: "Perth councils: heritage lists and heritage/character areas" },
        {
          ...
          cards: {
            ...
            rows: [
              ["City of Bayswater", "The Local Heritage Survey covers places and areas of cultural heritage significance; those in Management Categories 1-3 are eligible for the statutory Heritage List under the City's town planning scheme. Listing means development approval is required for all demolition, alterations or other development affecting the significance of the place or area. The Heritage Places Local Planning Policy adopted 27 July 2021 sets out how places are added or removed. The City does not publish a headline count.", "The Local Heritage Survey includes the Bayswater town centre and the Maylands town centre as designated heritage areas.", "https://www.bayswater.wa.gov.au/development/heritage/local-heritage-survey", "11/09/2026"],
              ...
              ["Town of Cambridge", "The Town's first Heritage List was adopted 27 November 2018 carrying 74 places, drawn from a Local Government Inventory of 118 places - now termed a Local Heritage Survey under the Heritage Act 2018. The List has been amended twice since, most recently 15 December 2020. Listing means planning approval is required for demolition and most development works.", "The Holyrood Street Conservation Area in West Leederville, covering Holyrood Street between Cambridge Street and Woolwich Street - the first heritage-listed street in the Town, with its own design guidelines dating to 2002. Applications for additions or new works within the precinct are referred to the Town's Heritage Architect.", "https://www.cambridge.wa.gov.au/Planning-Building/Planning/Planning-Rules/Heritage-Character", "11/09/2026"],
              ...
              ["Town of Cottesloe", "Heritage List under Local Planning Scheme No. 3, backed by a Local Heritage Survey - formerly a Municipal Inventory - most recently updated in 2025. Places on the Heritage List need development approval for most development works, and a Heritage Impact Statement may be required as part of the application. The Town does not publish a headline count.", "No named Heritage Area precinct was found separate from the Heritage List itself in this desk pass - check directly with the Town.", "https://www.cottesloe.wa.gov.au/develop-build/planning/heritage.aspx", "11/09/2026"],
              ...
              ["Town of Victoria Park", "A review and update of the Local Heritage Survey was approved by Council at its June 2021 Ordinary Council Meeting. Council then resolved in February 2022 to advertise a draft Heritage List and a draft Local Planning Policy 43 - Heritage List. A Heritage List gives statutory protection under the planning framework, including the ability to refuse demolition on heritage grounds. The Town does not publish a headline count.", "No named Heritage Area precinct was found separate from the Heritage List itself in this desk pass - check directly with the Town.", "https://www.victoriapark.wa.gov.au/develop-and-build/planning/planning-policies-and-legislation/local-heritage.aspx", "11/09/2026"]
            ]
          }
        },
